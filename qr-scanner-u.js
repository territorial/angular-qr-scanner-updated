...
angular.module('qrScannerU', ["ng"]).directive('qrScannerU', ['$interval', '$window', function($interval, $window)
{
  return {
    restrict: 'E',
    scope: {
    ...
    link: function(scope, element, attrs) {
      ...
      {
        video.srcObject = stream || (window.URL && window.URL.createObjectURL(stream));
